...
await SolveAsync<Aoc.Day24.Solution1>(inputs, exampleInput);
await SolveAsync<Aoc.Day24.Solution2>(inputs, exampleInput);

await SolveAsync<Aoc.Day25.Solution1>(inputs, exampleInput);
